...
class Commetic extends Component{
  ...
  componentDidMount() {
    ...
    overallHeatmap.on('click',(e)=>{
      ...
      this.setState({showParticularHeatmap:'particularHeatmap',showParticularLine:'particularLine'},this.drawParticularChart);
    })
  }
  drawParticularChart=()=>{
    //ParticularHeatmap
    ...
    return (
        <div>
          <div>
            ...
            <div id='overallHeatmap' className={styles.overallHeatmap}></div>
          </div>
          {/* 下级热力图 */}
          <div id={styles.particularHeatmapCon} className={this.state.showParticularHeatmap}>
            ...
            <Select defaultValue='title' style={{ width: 180 }} onChange={this.handleChange}>
